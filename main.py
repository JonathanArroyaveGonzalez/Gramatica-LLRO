...
lblGramatica = Label(canvas_principal, fg="white", bg="#3A91A6", width=18, text="Gramática",
                     font=("Times New Roman", 17)).place(x=50, y=20)

textGramatica = scrolledtext.ScrolledText(
    ventana, wrap=tk.WORD, width=23, height=14, font=("Arial", 15))
...
btn_Iniciar = Button(ventana, fg="white", bg="#18434D", width=15, text="Iniciar", state="normal", font=("Arial", 10),
                     command=iniciarPrograma)
btn_Iniciar.place(x=40, y=410)

# Este botón termina el programa:
btn_Salir = Button(canvas_principal, fg="white", bg="#18434D", width=15, text="Salir", font=("Arial", 10),
                   command=sys.exit).place(x=185, y=410)
